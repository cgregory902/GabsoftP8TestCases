...
public class TestViewDrugList {
  ...
  @Test
  public void testViewDrugList() throws Exception {
    ...
    driver.findElement(By.xpath("//div[@onclick='toggleNav()']")).click();
    driver.findElement(By.linkText("Your Drug List")).click();
    driver.get("http://jsic.ddns.net:8080/GabSoft/DBList");
  }
