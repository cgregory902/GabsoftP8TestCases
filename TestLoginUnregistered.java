...
public class TestLoginUnregistered {
  ...
  @Test
  public void testLoginUnregistered() throws Exception {
    ...
    driver.findElement(By.id("username")).sendKeys("bad username");
    driver.findElement(By.id("pass")).clear();
    driver.findElement(By.id("pass")).sendKeys("lkjflkjf");
    driver.findElement(By.xpath("//input[@value='Login']")).click();
    driver.get("http://jsic.ddns.net:8080/GabSoft/Welcome");
  }
