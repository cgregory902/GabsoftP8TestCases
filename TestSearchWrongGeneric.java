...
public class TestSearchWrongGeneric {
  ...
  @Test
  public void testSearchWrongGeneric() throws Exception {
    ...
    driver.findElement(By.id("genericName")).click();
    driver.findElement(By.id("genericName")).clear();
    driver.findElement(By.id("genericName")).sendKeys("supreme pizza");
    driver.findElement(By.xpath("//input[@value='Search']")).click();
    driver.get("http://jsic.ddns.net:8080/GabSoft/DrugSearch");
  }
